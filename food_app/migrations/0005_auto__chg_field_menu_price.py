...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('food_app_menu', 'price', self.gf('django_prices.models.PriceField')(decimal_places=4, currency='RUB', max_digits=10))

    def backwards(self, orm):

        # Changing field 'Menu.price'
        db.alter_column('food_app_menu', 'price', self.gf('django_prices.models.PriceField')(max_digits=6, currency='RUB', decimal_places=2))
    ...
    models = {
        ...
        'filer.image': {
            ...
            'file_ptr': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'primary_key': 'True', 'to': "orm['filer.File']"}),
            'must_always_publish_author_credit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'must_always_publish_copyright': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'subject_location': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '64', 'default': 'None', 'blank': 'True'})
        },
        'food_app.dish': {
        ...
        'food_app.menu': {
            ...
            'price': ('django_prices.models.PriceField', [], {'decimal_places': '4', 'currency': "'RUB'", 'max_digits': '10'})
        },
        'food_app.recipe': {
