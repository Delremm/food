...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Menu.menu_type'
        db.alter_column('food_app_menu', 'menu_type', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        'filer.file': {
            ...
            'folder': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Folder']", 'null': 'True', 'related_name': "'all_files'", 'blank': 'True'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'related_name': "'owned_files'", 'blank': 'True'}),
        ...
        'filer.folder': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'related_name': "'filer_owned_folders'", 'blank': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Folder']", 'null': 'True', 'related_name': "'children'", 'blank': 'True'}),
