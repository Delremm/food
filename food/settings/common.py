...
FORMEAL_CONF = {
    'MACRO': {
        'ACTIVITIES': [
            ...
            {'id': 1, 'name': "сидячий образ жизни", 'mul': 1.40,
                'description': 'офисный работник не занимающийся спортом'},
            {'id': 2, 'name': "легкая активность", 'mul': 1.5,
                'description': 'офисный работник занимающийся спортом 1-3 раза в неделю'},
            {'id': 3, 'name': "умеренная активность", 'mul': 1.6,
                'description':
                    'офисный работник занимающийся спортом 3-5 раз в неделю или рабочий занимающийся 1-3 раза в неделю'},
            {'id': 4, 'name': "высокая активность", 'mul': 1.8,
            ...
            {'id': 5, 'name': "сверхвысокая активность", 'mul': 2.0,
